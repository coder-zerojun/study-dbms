...
/* 회원상태, 회원번호, 아이디, 이름, 비밀번호, 전화번호, 닉네임, 이메일, 주소, 생년월일, 성별, 추천인 아이디*/
...
UPDATE TBL_USER SET USER_STATUS = '1' WHERE USER_IDENTIFICATION = 'lss1234';
...
ON U.USER_ID = F.FOLLOWER_ID AND F.FOLLOWING_ID = '21';
